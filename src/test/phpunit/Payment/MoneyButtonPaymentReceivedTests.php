...
class MoneyButtonPaymentReceivedTests extends TestCase {
	...
	public function test_should_apply_to_pending() {
		...
		\WP_Mock::expectAction( 'wc_gateway_moneybutton_payment_received',
		...
		$this->assertEquals( 'RECEIVED', $payment->get_status() );
